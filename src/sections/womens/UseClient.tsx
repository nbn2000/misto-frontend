...
import { SVG42, SVG43, SVG44, SVG45, SVG46 } from "@/svg/SVG"
...
export const TopBody = () => {
    ...
    const getValue = (e: string) => {
        dispatch(change({ men: spec.men, women: e, data: spec.data }))
    }
    return (
        <div>
            <div className="flex justify-between items-center flex-wrap">
                ...
                <details className="dropdown">
                    <summary className="m-1 btn flex flex-row justify-center items-center gap-1 bg-transparent">
                        <small className="btn-text text-dark opacity-60">{spec.women}</small>
                        <SVG46 />
                    </summary>
